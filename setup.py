# -*- coding: utf-8 -*-
"""`sphinx_btd_theme` lives on `Github`_.

.. _github: https://github.com/buildthedocs/sphinx.theme
...
setup(
    name='sphinx_btd_theme',
    version='0.5.0rc2',
    url='https://github.com/buildthedocs/sphinx.theme/',
    license='MIT',
    author='Build the Docs, based on work by Dave Snider, Read the Docs, Inc. & contributors',
    author_email='dev@readthedocs.org',
    description='Build the Docs theme for Sphinx',
    ...
    zip_safe=False,
    packages=['sphinx_btd_theme'],
    package_data={'sphinx_btd_theme': [
        'theme.conf',
        '*.html',
        'static/css/*.css',
        'static/css/fonts/*.*'
    ...
    entry_points = {
        'sphinx.html_themes': [
            'sphinx_btd_theme = sphinx_btd_theme',
        ]
    },
    install_requires=[
        'sphinx'
